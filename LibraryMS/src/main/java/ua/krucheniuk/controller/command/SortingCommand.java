...
public class SortingCommand implements Command {
	...
	public SortingCommand(SearchService searchService) {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		String sortingColumn = sortingColumnReq
				.orElse((String) request.getSession().getAttribute("activeSortingColumn"));

		List<Book> books = searchService.sortBooks((currentPage - 1) * recordsOnPage, recordsOnPage, activeSortingType,
				sortingColumn);
